...
public abstract class PreinsertedDataContainer {
    ...
    public static final int NUMBER_OF_PREINSERTED_FURNITURE = 2;
    ...
    public static final ClientOrder PREINSERTED_CLIENT_ORDER_2 = new ClientOrder(2L, false, PaymentMethod.CASH, BigDecimal.TEN, false);
    public static final ClientOrder PREINSERTED_CLIENT_ORDER_WITHOUT_ORDER_HISTORY = new ClientOrder(3L, false, PaymentMethod.CASH, BigDecimal.valueOf(20), false);
    public static final int NUMBER_OF_PREINSERTED_CLIENT_ORDERS = 3;
    ...
    public static final OrderHistory PREINSERTED_ORDER_HISTORY_2 = new OrderHistory(2L, PREINSERTED_CLIENT_ORDER_2, LocalDateTime.of(2019, 1, 1, 0, 0), OrderState.PIKING);
    public static final int NUMBER_OF_PREINSERTED_ORDER_HISTORY = 2;

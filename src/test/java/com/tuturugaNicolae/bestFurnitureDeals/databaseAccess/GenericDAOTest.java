...
public abstract class GenericDAOTest<T> {
    protected static final User PREINSERTED_USER_1 = new User(1L, "tuturuga", "12345", "tuturuganicu@gmail.com", BigDecimal.ZERO, UserType.CLIENT);
    ...
    protected static final Furniture PREINSERTED_FURNITURE_1 = new Furniture(1L, "Chair", "Strong material", 1);
    ...
    protected static final Deal PREINSERTED_DEAL_1 = new Deal(1L, "Chair", DealType.REDUCED, PREINSERTED_FURNITURE_1, BigDecimal.TEN, true);
    protected static final int NUMBER_OF_PREINSERTED_DEALS = 1;
    ...
    protected static final ClientOrder PREINSERTED_CLIENT_ORDER_WITHOUT_ORDER_HISTORY = new ClientOrder(1L, false, PaymentMethod.CASH, BigDecimal.TEN);
    ...
    public void testDelete(GenericDAO genericDAO, T objectToDelete, int expectedNumberOfObjectsAfterDelete) {

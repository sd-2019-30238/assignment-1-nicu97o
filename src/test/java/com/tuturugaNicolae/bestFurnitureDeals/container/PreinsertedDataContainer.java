...
public abstract class PreinsertedDataContainer {
    ...
    public static final UserDTO PREINSERTED_USERDTO_1 = new UserDTO("tuturuga", "tuturuganicu@gmail.com", UserType.CLIENT);
    public static final UserDTO PREINSERTED_USERDTO_2 = new UserDTO("nicu", "nicu.tuturuga@yahoo.com", UserType.STAFF);
    ...
    public static final DealDTO PREINSERTED_DEALDTO_1 = new DealDTO(1L, "Chair", DealType.REDUCED, PREINSERTED_FURNITUREDTO_1, BigDecimal.TEN, true, 1);
    ...
    public static final DealDTO PREINSERTED_DEALDTO_2 = new DealDTO(2L, "Chair 2", DealType.REDUCED, PREINSERTED_FURNITUREDTO_1, BigDecimal.ONE, true, 1);
    ...
    public static final ClientOrderDTO PREINSERTED_CLIENT_ORDERDTO_1 = new ClientOrderDTO(1L, false, PaymentMethod.CASH, BigDecimal.TEN, true, PREINSERTED_USERDTO_1);
    ...
    public static final OrderHistoryDTO PREINSERTED_ORDER_HISTORYDTO_1 = new OrderHistoryDTO(1L, PREINSERTED_CLIENT_ORDERDTO_1, LocalDateTime.of(2019, 1, 1, 0, 0), OrderState.PLACED);
